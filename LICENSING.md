...
`abgeordnetenwatch-cli` is **dual-licensed**. You may use it under **either** of the
...
- embed `abgeordnetenwatch-cli` in a **closed-source / proprietary product**, or
...
> fetches.** The abgeordnetenwatch.de data served by the API is released
> separately under **CC0 1.0** (public domain); see [DATA_LICENSE.md](DATA_LICENSE.md).
